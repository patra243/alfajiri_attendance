...
public class StudentAddActivity extends AppCompatActivity {
    ...
    EditText firstName, lastName, phoneNumber, addressMail, passWord;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addressMail = (EditText) findViewById(R.id.txtEmailaddress);
        passWord = (EditText) findViewById(R.id.txtPassword);

        suBmit = (Button) findViewById(R.id.btnSubmit1);
        canCel = (Button) findViewById(R.id.btnCancel1);
        ...
        suBmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String add_mail = addressMail.getText().toString();
                ...
                else if (TextUtils.isEmpty(add_mail)) {
                    addressMail.setError("Please Enter Email Address");
                }
                else if (TextUtils.isEmpty(passwordz)) {
                    passWord.setError("Please Enter Password");
                }
                else {
                    GetSetStudent getSetStudent = new GetSetStudent();

                    getSetStudent.setStudent_fname(fname);
                    getSetStudent.setStudent_lname(lname);
                    getSetStudent.setStudent_phone(phone_no);
                    getSetStudent.setStudent_email(add_mail);
                    getSetStudent.setStudent_faculty(faculty);
                    getSetStudent.setStudent_department(department);

                    DBHelper helper = new DBHelper(StudentAddActivity.this);
                    helper.insertStudent(getSetStudent);

                    Intent intent = new Intent(StudentAddActivity.this, MenuActivity.class);
